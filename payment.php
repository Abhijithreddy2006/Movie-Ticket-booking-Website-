...
<body class="bg-gray-900 text-white">
    ...
    <div class="container mx-auto mt-8">
        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-xl max-w-md mx-auto">
            ...
            <form action="receipt.php" method="POST" class="mt-6">
                <button type="submit" class="w-full bg-green-500 text-white py-2 rounded hover:bg-green-600">Confirm Payment</button>
            </form>
        </div>
    </div>
